  ...
  return /******/ (() => {
    ...
    (() => {
      ...
      function isEditable(node) {
        return (
          node && external_jQuery_default()(node).hasClass("note-editable")
        );
      }
      /**
      ...
      function isControlSizing(node) {
        return (
          node &&
          external_jQuery_default()(node).hasClass("note-control-sizing")
        );
      }
      /**
          ...
          },
          {
            ...
            value: function pasteHTML(markup) {
              ...
              var contentsContainer =
                external_jQuery_default()("<div></div>").html(markup)[0];
        ...
        Bullet_createClass(Bullet, [
          ...
          },
          {
            ...
            value: function wrapList(paras, listName) {
              ...
              var listNode =
                prevList || dom.insertAfter(dom.create(listName || "UL"), last); // P to LI
            ...
            value: function addRow(rng, position) {
              ...
              if (position === "top") {
                ...
                if (cellHasRowspan) {
                  ...
                  external_jQuery_default()(
                    external_jQuery_default()(currentTr).parent().find("tr")[
                      lastTrIndex
                    ]
      ...
      var Editor = /*#__PURE__*/ (function () {
        function Editor(context) {
          ...
          this.insertNode = this.wrapCommand(function (node) {
            if (
              _this.isLimited(external_jQuery_default()(node).text().length)
            ) {
              return;
            }
          ...
          this.createLink = this.wrapCommand(function (linkInfo) {
            ...
            if (isTextChanged) {
              ...
              var anchor = rng.insertNode(
                external_jQuery_default()("<A>" + linkText + "</A>")[0]
              );
              anchors.push(anchor);
            } else {
          ...
          },
          {
            ...
            value: function setLastRange(rng) {
              if (rng) {
                ...
                if (
                  external_jQuery_default()(this.lastRange.sc).closest(
                    ".note-editable"
                  ).length === 0
                ) {
                    ...
                    external_jQuery_default().each(
                      ...
                      function (idx, type) {
                        ...
                        if (type.toLowerCase().indexOf("text") > -1) {
                          ...
                          external_jQuery_default()(content).each(function (
                            idx,
                            item
                          ) {
        ...
        Statusbar_createClass(Statusbar, [
          {
            ...
            value: function initialize() {
              ...
              this.$statusbar.on("mousedown", function (event) {
                ...
                var editableCodeTop =
                  _this.$codable.offset().top - _this.$document.scrollTop();

                var onMouseMove = function onMouseMove(event) {
                  var height = event.clientY - (editableTop + EDITABLE_PADDING);
                  var heightCode =
                    event.clientY - (editableCodeTop + EDITABLE_PADDING);
                  height =
                  ...
                  children: [
                    this.button({
                      ...
                      click: function click(e) {
                        var $button = external_jQuery_default()(
                          e.currentTarget
                        );
                ...
                return _this2.ui
                  .buttonGroup([
                    ...
                    _this2.ui.dropdownCheck({
                      ...
                      click:
                        _this2.context.createInvokeHandler("editor.lineHeight"),
                    }),
                  ])
                  .render();
              });
              ...
              this.context.memo("button.removeMedia", function () {
                return _this3
                  .button({
                    ...
                    click:
                      _this3.context.createInvokeHandler("editor.removeMedia"),
                  })
                  .render();
              });
            },
              ...
              this.context.memo("button.deleteTable", function () {
                return _this5
                  .button({
                    ...
                    click:
                      _this5.context.createInvokeHandler("editor.deleteTable"),
                  })
                  .render();
              });
            },
              ...
              if (styleInfo["line-height"]) {
                ...
                $cont
                  ...
                  .each(function (idx, item) {
                    ...
                    var isChecked =
                      external_jQuery_default()(item).data("value") + "" ===
                      lineHeight + "";
                    $item.toggleClass("checked", isChecked);
                  });
        ...
        LinkDialog_createClass(LinkDialog, [
          {
            ...
            value: function initialize() {
              ...
              var buttonClass =
                "btn btn-success note-btn note-btn-primary note-link-btn";
          ...
          this.events = {
            ...
            "summernote.blur": function summernoteBlur(we, e) {
              if (e.originalEvent && e.originalEvent.relatedTarget) {
                if (
                  !_this.$popover[0].contains(e.originalEvent.relatedTarget)
                ) {
                  _this.hide();
                }
              } else {
        ...
        ImageDialog_createClass(ImageDialog, [
          {
            ...
            value: function initialize() {
              ...
              var buttonClass =
                "btn btn-success note-btn note-btn-primary note-image-btn";
              var footer = '<input type="button" href="#" class="'
                .concat(buttonClass, '" value="')
        ...
        VideoDialog_createClass(VideoDialog, [
          {
            ...
            value: function initialize() {
              ...
              var buttonClass =
                "btn btn-success note-btn note-btn-primary note-video-btn";
              var footer = '<input type="button" href="#" class="'
                .concat(buttonClass, '" value="')
      ...
      /* harmony default export */ const renderer = {
        create: function create(markup, callback) {
          return function () {
            var options =
              _typeof(arguments[1]) === "object" ? arguments[1] : arguments[0];
      ...
      function TooltipUI_createClass(Constructor, protoProps, staticProps) {
        if (protoProps)
          TooltipUI_defineProperties(Constructor.prototype, protoProps);
        ...
        TooltipUI_createClass(TooltipUI, [
          {
            ...
            value: function show() {
              ...
              var targetOffset = external_jQuery_default()(
                this.options.target
              ).offset();
          ...
          },
          {
            ...
            value: function show() {
              ...
              var targetMarginRight = parseFloat(
                external_jQuery_default()(this.options.target).css(
                  "margin-right"
                )
              );
      ...
      external_jQuery_default()(document).on("click", function (e) {
        if (
          !external_jQuery_default()(e.target).closest(".note-btn-group").length
        ) {
      ...
      external_jQuery_default()(document).on(
        "click.note-dropdown-menu",
        function (e) {
      ...
      var ModalUI = /*#__PURE__*/ (function () {
        function ModalUI(
          ...
          this.$modal = $node;
          this.$backdrop = external_jQuery_default()(
      ...
      var toolbar = renderer.create(
        '<div class="note-toolbar" role="toolbar"></div>'
      );
      var editingArea = renderer.create(
        '<div class="note-editing-area"></div>'
      );
        ...
        function ($node, options) {
          ...
          if (options && options.tooltip) {
            ...
            $node
              ...
              .on("click", function (e) {
                external_jQuery_default()(e.currentTarget)
                  .data("_lite_tooltip")
                  .hide();
              });
          }
