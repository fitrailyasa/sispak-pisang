      ...
      (() => {
            ...
            return t.length
              ? b(t).reduce(
                  function (t, o) {
                    var n = g(t);
                    return (
                      e(g(n), o) ? (n[n.length] = o) : (t[t.length] = [o]), t
                    );
                  },
                  [[m(t)]]
                )
        ...
        function nt(t, e) {
          ...
          if (j(t.node))
            return null === t.node
              ? null
              : { node: (o = t.node.nextSibling), offset: (n = 0) };
          if (O(t.node) === t.offset) {
            if (C(t.node)) return null;
            (o = t.node.parentNode),
              (n = J(t.node) + 1),
          ...
          } else if (((o = t.node), (n = e ? O(t.node) : t.offset + 1), j(o)))
            return null;
          return { node: o, offset: n };
        }
        function it(t) {
        ...
        const ht = {
          ...
          splitPoint: function (t, e) {
            ...
            var s =
              o &&
              st(o, t, { isSkipPaddingBlankHTML: e, isNotSplitEdgePoint: e });
            return (
              ...
              },
              {
                ...
                value: function (t, o) {
                  ...
                  return function (i) {
                    ...
                    n.invoke(
                      t,
                      o || r.closest("[data-value]").data("value"),
                      r
                    );
                  };
                },
          ...
          var e = document.body.createTextRange(),
            o = (function t(e, o) {
              ...
              if (ht.isText(e)) {
                ...
                (n = a || e.parentNode),
                  (o += y.sum(y.tail(r), ht.nodeLength)),
                  (i = !a);
              } else {
                ...
                value: function () {
                  var e = function (t, e) {
                      ...
                      if (!n) {
                        ...
                        n =
                          (ht.isLeftEdgePointOf(t, o) || ht.isVoid(i.node)) &&
                          !e;
                      }
                      var r = !1;
                      if (!r) {
                        ...
                        r =
                          (ht.isRightEdgePointOf(t, o) || ht.isVoid(a.node)) &&
                          e;
                      }
                      if (n || r) {
                ...
                value: function () {
                  ...
                  return (
                    e().each(n, function (t, e) {
                      var o = e.parentNode;
                      i.node !== o && 1 === ht.nodeLength(o) && r.push(o),
                        ht.remove(e, !1);
                    }),
        ...
        const kt = {
          ...
          createFromNode: function (t) {
            ...
            return (
              ht.isVoid(e) &&
                ((o = ht.listPrev(e).length - 1), (e = e.parentNode)),
              ht.isBR(n)
                ? ((i = ht.listPrev(n).length - 1), (n = n.parentNode))
                : ht.isVoid(n) &&
                  ((i = ht.listPrev(n).length), (n = n.parentNode)),
              this.create(e, o, n, i)
            );
          },
        ...
        const wt = {
          isEdit: function (t) {
            return y.contains(
              [yt.BACKSPACE, yt.TAB, yt.ENTER, yt.SPACE, yt.DELETE],
              t
            );
          },
          isMove: function (t) {
              ...
              },
              {
                ...
                value: function (t, e) {
                  ...
                  return (
                    ...
                    r &&
                      (ht.appendChildNodes(a, y.from(r.childNodes)),
                      ht.remove(r)),
                    t
                  );
                },
              ...
              },
              {
                ...
                value: function (t, o) {
                  ...
                  if (i) {
                    ...
                    (n = e()(ht.emptyPara)[0]),
                      l ? o.sc.insertBefore(n, l) : o.sc.appendChild(n);
                  }
            ...
            (n = [
              ...
              },
              {
                ...
                value: function (t, o) {
                  if (
                    ...
                    o &&
                      o.length &&
                      (o[0].tagName.toUpperCase() !== t.toUpperCase() &&
                        (o = o.find(t)),
                      o && o.length))
                  ) {
              ...
              },
              {
                ...
                value: function () {
                  ...
                  return (
                    o.length && (n.isNewWindow = "_blank" === o.attr("target")),
                    n
                  );
                },
              },
            ...
            return (
              ...
              (n = [
                ...
                },
                {
                  key: "handleKeyup",
                  value: function (t) {
                    y.contains([wt.code.ENTER, wt.code.SPACE], t.keyCode) &&
                      this.replace();
                  },
                },
              ]) && Yt(o.prototype, n),
              ...
              },
              {
                ...
                value: function (t) {
                  if (
                    ...
                    y.contains(this.keys, this.previousKeydownCode)
                  )
                  ...
                  return (
                    Object.prototype.hasOwnProperty.call(
                      ...
                      (this.fontInstalledMap[t] =
                        f.isFontInstalled(t) ||
                        y.contains(this.options.fontNamesIgnoreCheck, t)),
                    this.fontInstalledMap[t]
                  );
                },
              },
                ...
                value: function (t) {
                  ...
                  if (n && 11 === n[1].length) {
                    ...
                    if (void 0 !== n[2]) {
                      ...
                      if (k)
                        for (
                          var y = [3600, 60, 1], w = 0, C = y.length;
                          w < C;
                          w++
                        )
                          b +=
                            void 0 !== k[w + 1]
                              ? y[w] * parseInt(k[w + 1], 10)
                              : 0;
                    }
                    o = e()("<iframe>")
                      .attr("frameborder", 0)
            ...
            (n = [
              {
                ...
                value: function () {
                  return (
                    this.options.airMode && !y.isEmpty(this.options.popover.air)
                  );
                },
              },
              {
                ...
                value: function (t, o) {
                  ...
                  return (
                    this.searchKeyword(t, o, function (e) {
                      (e = e || []).length &&
                        (i.html(n.createItemTemplates(t, e)), n.show());
                    }),
                    i
                  );
                },
                    ...
                    if (this.hints.length && i) {
                      ...
                      a &&
                        ...
                        this.hints.forEach(function (t, e) {
                          t.match.test(i) &&
                            o.createGroup(e, i).appendTo(o.$content);
                        }),
                        this.$content
              ...
              this.options.trigger.split(" ").forEach(function (t) {
                "hover" === t
                  ? (o.off("mouseenter mouseleave"),
                    o.on("mouseenter", i).on("mouseleave", r))
                  : "click" === t
                  ? o.on("click", a)
            ...
            (n = [
              {
                ...
                value: function () {
                  ...
                  var i = this.$tooltip,
                    r =
                      this.options.title || t.attr("title") || t.data("title"),
                  ...
                  "bottom" === a
                    ...
                    : "right" === a &&
                      i.css({ top: o.top + (l / 2 - u / 2), left: o.left + s }),
                    i.addClass("in");
                },
              },
              {
              ...
              },
              {
                ...
                value: function () {
                  ...
                  var t = this.$button.next(),
                    ...
                    i = e()(window).width(),
                    r = parseFloat(
                      e()(this.options.target).css("margin-right")
                    );
                  o.left + n > i - r
            ...
            function (t, o) {
              o &&
                ...
                t
                  .data(
                    "_lite_tooltip",
                    new Re(t, { title: o.tooltip, container: o.container })
                  )
                  .on("click", function (t) {
                ...
                o &&
                  ...
                  t.data(
                    "_lite_dropdown",
                    new Fe(t, { container: o.container })
                  ),
            ...
            function (t, o) {
              var n = Array.isArray(o.items)
                ? o.items.map(function (t) {
                    ...
                    return (
                      r.html([lo(o.checkClassName), " ", i]).data("item", t), r
                    );
                  })
                : o.items;
              t.html(n).attr({ "aria-label": o.title }),
          ...
          to = Ie('<div class="note-color-palette"></div>', function (t, o) {
            ...
            t.html(n.join("")),
              t.find(".note-color-btn").each(function () {
                e()(this).data(
                  "_lite_tooltip",
                  new Re(e()(this), { container: o.container })
                );
              });
          }),
          eo = function (t, o) {
